...
public class MongoDbEndpoint extends DefaultEndpoint implements EndpointServiceLocation {
    ...
    @UriParam(label = "consumer,changeStream")
    private String streamResumeToken;
    ...
    public String getStreamResumeToken() {
     ...
     */
    public void setStreamResumeToken(String streamResumeToken) {
        this.streamResumeToken = streamResumeToken;
    }
